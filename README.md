...
This package is a generic XR platform implementation of Unity PolySpatial. XR-specific dependencies and elements developed for PolySpatial should generally instead land in this package. 
...
1. **Follow our design guidelines**
	...
	* The [UX Checklist](https://unityeditordesignsystem.unity.com/foundations/ux-checklist) In Unity's Editor Design System.
...
1. Open the template preview: [Unity Standards checklist for packages, templates, and feature sets](https://docs.google.com/spreadsheets/d/1-v4ELEYcKlHHvu-1ShzYeTTG4NGcHiu_mXDF2oFVvGc/template/preview).
...
For more information, see [How to validate a package or template against Unity Standards](https://confluence.unity3d.com/display/SCHOL/How+to+validate+a+package+or+template+against+Unity+Standards).
